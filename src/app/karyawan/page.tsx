        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-2">
            ...
            <p className="mb-4 text-justify text-[#666666]">
              ...
              menjadi entitas induk yang terus mengembangkan sayapnya pada
              sektor kesehatan di Indonesia. Pada 2014, Perseroan melakukan
              merger dengan Prafa, yang menggabungkan diri ke dalam Darya-Varia.
            </p>
            <p className="mb-4 text-justify text-[#666666]">
              Saat ini, Darya-Varia mengoperasikan dua pabrik yang telah
              memenuhi standar internasional Cara Pembuatan Obat yang Baik
              (CPOB) dan standar Badan Pengawas Obat dan Makanan (BPOM).
            </p>
            <p className="mb-4 text-justify text-[#666666]">
              Produk kapsul gelatin lunak, produk sediaan cair, plester obat,
              salep, dan krim diproduksi di Pabrik Gunung Putri. Dalam
              memproduksi produk-produk tersebut, Pabrik Gunung Putri menerapkan
              Sistem Manajemen Terpadu dan memperoleh sertifikat ISO 9001:2015,
              ISO 14001:2015, ISO 45001:2018 dan ISO 22000:2018.
            </p>
            <p className="mb-4 text-justify text-[#666666]">
          ...
          <div className="md:col-span-3">
            <p className="mb-4 text-justify text-[#666666]">
              ...
              Pabrik Cimanggis Depok. Perseroan telah dipercaya oleh mitra
              bisnis lokal dan asing baik untuk pasar domestik dan internasional
              untuk bisnis Ekspor & Toll Manufacturing dan melakukan transfer
              teknologi, uji coba lab dan pilot, studi stabilitas, pengadaan
              bahan baku dan kemasan, dan produksi komersial barang jadi yang
              berkualitas.
            </p>
            <p className="mb-4 text-justify text-[#666666]">
              Darya-Varia selalu memastikan mutu dan keamanan dari setiap
              produknya, sehingga semua produknya telah bersertifikat halal.
              Seluruh fasilitas pabrik yang dimiliki Darya-Varia telah
              menerapkan sistem jaminan halal.
            </p>
            <p className="mb-4 text-justify text-[#666666]">
              Blue Sphere Singapore Pte Ltd (BSSPL) adalah pemilik 92,13% saham
              Darya-Varia. Selama 46 tahun, Darya-Varia terus bergerak maju
              untuk memberikan fasilitas kesehatan yang bermutu tinggi. Melalui
              misi “membangun Indonesia yang lebih sehat setiap orang di setiap
              waktu”, Darya-Varia selalu berkomitmen untuk menyediakan beragam
              produk berkualitas dengan strategi yang tepat untuk kesehatan

...
export default function UpdateCategory({ category, onUpdate }: UpdateCategoryProps) {
  ...
  async function handleSubmit(e: SyntheticEvent) {
    ...
    const response = await fetch(`https://www.salman4l.my.id/api/categories/${category.id_category}`, {
      method: "PUT",
      headers: {
